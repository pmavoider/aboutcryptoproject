...
let oldArray = [
   ...
   // {name:"Avalanche" , img:"images2/avalanche-logo.png", description:"Avalanche describes itself as an open, programmable smart contracts platform for decentralized applications. AVAX is used to pay transaction fees and can be staked to secure the network. Avalanche is compatible with Solidity, Ethereum’s programming language, and can be used to deploy custom private or public blockchains as subnets.", founder:"Emin Gün Sirer, Kevin Sekniqi, Maofan “Ted” Yin", whitePaper:"https://www.avalabs.org/whitepapers", released:"09/2020", symbol:"AVAX"},
    ...
    {name:"Helium" ,id:"helium", img:"images2/helium-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Huobi" , id:"huobi-token", img:"images2/huobi-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Internet Computer" , id:"internet-computer",  img:"images2/internet-computer-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Klaytn" , id:"klay-token", img:"images2/klaytn-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
   // {name:"Kucoin Token" ,id:"",  img:"images2/kucoin-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Litecoin" , id:"litecoin",  img:"images2/litecoin-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Maker" , id:"maker" , img:"images2/maker-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Monero" , id:"monero",  img:"images2/monero-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Near" , id:"near",  img:"images2/near-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Polkadot" , id:"polkadot",  img:"images2/polkadot-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    //{name:"Polygon" , id:"polygon",  img:"images2/polygon-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Shiba inu" , id:"shiba-inu", img:"images2/shiba-inu-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Solana" , id:"solana", img:"images2/solana-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Stellar" , id:"stellar",  img:"images2/stellar-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Tether" , id:"tether",  img:"images2/tether-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Tezos" , id:"tezos",  img:"images2/tezos-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"The Sandbox" , id:"the-sandbox",  img:"images2/the-sandbox-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Theta Network" , id:"theta-token" , img:"images2/theta-network-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Tron" , id:"tron" ,  img:"images2/tron-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"TrueUSD" , id:"true-usd",  img:"images2/trueusd-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Uniswap" , id:"uniswap",  img:"images2/uniswap-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    ...
    {name:"Vechain" , id:"vechain",  img:"images2/vechain-logo.png", description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Wrapped Bitcoin" , id:"wrapped-bitcoin",  img:"images2/wrapped-bitcoin-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
   // {name:"XRP" , id:"xrp",  img:"images2/xrp-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""},
    {name:"Zcash" , id:"zcash",  img:"images2/zcash-logo.png" , description:"", founder:"", whitePaper:"", released:"", symbol:""} ]
...
function hello(){
    console.log("hello")
        ...
        const newArray = oldArray.map((x) => {
            return (
                displayArray.push(`<div id=${x.name} value=${x.name} class="col-4 col-sm-3 col-lg-2 mt-2"><a href="cryptobreakout.html?name=${x.id}">
